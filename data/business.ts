...
export const companyTypeOptions: Array<{
...
}> = [
  {
    value: "small",
    label: "شركة صغيرة",
    hint: "فرق صغيرة وبنية تشغيلية مركزة تحتاج إلى حماية مرنة وسريعة.",
  },
  {
    value: "medium",
    label: "شركة متوسطة",
    hint: "منشآت نامية تحتاج إلى تغطية أوسع وإدارة أوضح للمخاطر.",
  },
  {
    value: "large",
    label: "شركة كبيرة",
    hint: "بيئات تشغيلية كبيرة مع عدد أعلى من الأصول والتوزيع الداخلي.",
  },
  {
    value: "education",
    label: "جهة تعليمية",
    hint: "بيئات متعددة المستخدمين تحتاج تنظيم الوصول والأنظمة والخدمات.",
  },
  {
    value: "technology",
    label: "جهة تقنية",
    hint: "بنية رقمية كثيفة واعتماد أكبر على الخدمات السحابية والتطبيقات.",
  },
  {
    value: "government",
    label: "جهة حكومية",
    hint: "حساسية أعلى للامتثال والاستمرارية وحوكمة الأمن المؤسسي.",
  },
  {
    value: "other",
    label: "أخرى",
    hint: "حالات خاصة يمكن لفريق المبيعات تخصيصها حسب الاحتياج.",
  },
];
