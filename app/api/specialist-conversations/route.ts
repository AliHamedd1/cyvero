...
export async function POST(request: Request) {
  ...
  const conversation: SpecialistConversation = {
    ...
    updatedAt: now,
    verificationNote:
      "تم التحقق الأولي من تنسيق الاسم، البريد الإلكتروني، رقم الجوال، وحقول التعريف الأساسية داخل الواجهة.",
    client: {
  ...
  await writeRuntimeCollection(runtimeFiles.specialistConversations, nextConversations);
