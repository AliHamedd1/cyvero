...
const salesNotes = [
  ...
  },
  {
    ...
    description: "تستكمل هنا رحلة العميل بعد الحاسبة دون فقدان السياق أو الحاجة لإعادة إدخال البيانات الفنية.",
  },
  {
    icon: ShieldCheck,
    title: "نسخة أولية آمنة",
    description: "كل شيء هنا تجريبي داخل الواجهة فقط، مع الحفاظ على هوية احترافية قابلة للتوسعة لاحقًا.",
  },
];
...
export const metadata: Metadata = {
  ...
  description:
    "صفحة المبيعات في Cyvero مع ملخص طلب منقول من حلول الشركات ونموذج تواصل احترافي لفريق المبيعات.",
};
